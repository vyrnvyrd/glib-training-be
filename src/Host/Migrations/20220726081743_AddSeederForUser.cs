...
{
    public partial class AddSeederForUser : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "CreatedBy", "CreatedDate", "DeletedBy", "DeletedDate", "Email", "Fullname", "IsActive", "LastLogin", "Password", "UpdatedBy", "UpdatedDate", "Username" },
                values: new object[] { new Guid("784d69e6-abc3-47f9-9245-9527d6b2f17c"), new Guid("81314787-537b-474f-999a-9152c9703bbb"), new DateTime(2022, 7, 26, 15, 17, 32, 514, DateTimeKind.Local).AddTicks(158), new Guid("00000000-0000-0000-0000-000000000000"), null, "vyrnvyrd@gmail.com", "Firna Firdiani", true, null, "$2a$11$V.euh8IrN52sgej5Q7KZB.hSreXXCoyzETl2GfrAPZfi3ijhkSBbK", new Guid("00000000-0000-0000-0000-000000000000"), null, "firnafird" });
        }
