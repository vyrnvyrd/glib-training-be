// <copyright file="BackgroundJobCollection.cs" company="CV Garuda Infinity Kreasindo">
...
namespace Garuda.Modules.Hangfire.Configurations
{
    public class BackgroundJobCollection
    {
        ...
        {
            var jobDescriptor = _jobDescriptorsByArgsType.GetValueOrDefault(argsType);
        ...
        {
            var jobDescriptor = _jobDescriptorsByName.GetValueOrDefault(name);
